...
<div class="card my-2">
    <div class="card-header">
        <div class="d-flex">
            ...
            <h4 class="card-title" style="margin-left: 10px;">TABLERO DE UTILIDADES MASIVOS</h4>
        </div>                   
    </div>
</div>
                        ...
                        <thead class="" style="font-size: 10px;background-color:#FF2029">
                            <tr>
                                @if ($year = 2024 && $month <= 8)
                                    <th class="      " style="color: #FFF;border: 1px solid #FFF;">VIAJES</th>
                                @else
                            ...
                            <div class="card-body py-0">
                                <div class="row align-items-center">
                                    <div class="col text-center">
                                        ...
                                        @if ($year = 2024 && $month <= 8)
                                            <h6 class="text-uppercase text-muted m-0">TOTAL VIAJES</h6>
                                        @else
                                            <h6 class="text-uppercase text-muted m-0">TOTAL VIAJES</h6>
                                        @endif
                                    </div>
