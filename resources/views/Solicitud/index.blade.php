            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                button.removeClass('btn-warning').addClass('btn-success disabled').css('pointer-events', 'none');
                                button.find('i').removeClass('fa-minus').addClass('fa-check');
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                Swal.fire(
                                    'Error!',
                                    response.message || 'No se pudo verificar la solicitud.',
                                    'error'
                                );
                            }
                        },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $(input).replaceWith(
                                '<a href="/solicitud/soporte/' + pk + '" target="_blank" title="Ver soporte">' + icono + '</a>'
                            );
                            Swal.fire('¡Guardado!', 'El soporte ha sido cargado correctamente.', 'success');
                        } else {
