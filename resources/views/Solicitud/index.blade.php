                ...
                <div class="d-flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path d="M18 16L16 16M16 16L14 16M16 16L16 14M16 16L16 18" stroke="#FF2029"
                                stroke-width="1.5" stroke-linecap="round" />
                            <path d="M7 4V2.5" stroke="#FF2029" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M17 4V2.5" stroke="#FF2029" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M21.5 9H16.625H10.75M2 9H5.875" stroke="#FF2029" stroke-width="1.5"
                                stroke-linecap="round" />
                            <path
                                d="M14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2 19.6569 2 17.7712 2 14V12C2 8.22876 2 6.34315 3.17157 5.17157C4.34315 4 6.22876 4 10 4H14C17.7712 4 19.6569 4 20.8284 5.17157C22 6.34315 22 8.22876 22 12V14C22 17.7712 22 19.6569 20.8284 20.8284C20.1752 21.4816 19.3001 21.7706 18 21.8985"
                                stroke="#FF2029" stroke-width="1.5" stroke-linecap="round" />
                        </g>
                    </svg>
                        ...
                        <div class="d-flex flex-wrap justify-content-center align-items-center">
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:140px">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><svg height="18" width="18"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:140px">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><svg fill="#FF2029"
                                            height="18" width="18" version="1.1" id="Capa_1"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 297 297"
                                            xml:space="preserve" stroke="#FF2029">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <g id="SVGRepo_iconCarrier">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:150px">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><svg width="18"
                                            height="18" viewBox="0 0 1024 1024" class="icon" version="1.1"
                                    ...
                                    <select class="form-select" autocomplete="off" name="radicado"
                                        style="font-size: 11px">
                                        <option selected disabled>RADICADO</option>
                                        @foreach ($radicados as $radical)
                                            <option value="{{ $radical->radicado }}">
                                                {{ strToUpper($radical->radicado) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:180px">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><svg version="1.1"
                                    ...
                                    <select class="form-select" autocomplete="off" name="paytype"
                                        style="font-size: 11px">
                                        <option selected disabled>MEDIO DE PAGO</option>
                                        @foreach ($pagos as $pago)
                                            <option value="{{ $pago->paytype }}">{{ strToUpper($pago->paytype) }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <span class="input-group-text" id="basic-addon1"><svg width="18"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                <path
                                                    ...
                                                    stroke="#FF2029" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </g>
                                        </svg></span>
                                    <select class="form-select" autocomplete="off" name="fecha_cargue"
                                        style="font-size: 11px">
                                        <option selected disabled>FECHA CARGUE</option>
                                        @foreach ($cargues as $cargue)
                                            <option value="{{ $cargue->fecha_cargue }}">{{ $cargue->fecha_cargue }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:180px">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" autocomplete="off" name="fecha_descargue"
                                        style="font-size: 11px">
                                        <option selected disabled>FECHA DESCARGUE</option>
                                        @foreach ($descargues as $descargue)
                                            <option value="{{ $descargue->fecha_descargue }}">
                                                {{ $descargue->fecha_descargue }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:140px">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" autocomplete="off" name="placa"
                                        style="font-size: 11px">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:160px">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" autocomplete="off" name="razon"
                                        style="font-size: 11px">
                                        <option selected disabled>MANIFIESTO</option>
                                        @foreach ($manifiestos as $manifiesto)
                                            <option value="{{ $manifiesto->razon }}">{{ $manifiesto->razon }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:150px">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" autocomplete="off" name="sucursal"
                                        style="font-size: 11px">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 mx-1" style="width:150px">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" autocomplete="off" name="tipo_trayecto"
                                        style="font-size: 11px">
                                        <option selected disabled>TRAYECTO</option>
                                        @foreach ($trayectos as $trayecto)
                                            <option value="{{ $trayecto->tipo_trayecto }}">
                                                {{ $trayecto->tipo_trayecto }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <table id="exampl" class="table table-striped mb-0" style="transform: rotateX(180deg);">
                    <thead class="table-darke" style="font-size: 11px;background-color:#021526">
                        <tr>
                            ...
                            @can('novedades')
                            <th class="celdas" style="color: #00FF9C;border: 1px solid #0c213a;">NOVEDAD</th>
                            @endcan
                            ...
                            <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">TELEFONO CONDUCTOR
                            </th>
                        ...
                        @foreach ($diarias as $diario)
                            ...
                            <tr style="text-align: center">
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('fechas')
                                        <a href="#" class="editable" data-type="text" data-name="fecha_cargue"
                                            data-pk="{{ $diario->id }}">
                                            {{ $diario->fecha_cargue }}
                                        </a>
                                    @else
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('fechas')
                                        <a href="#" class="editable" data-type="text" data-name="hora_cargue"
                                            data-pk="{{ $diario->id }}">
                                            {{ $diario->hora_cargue }}
                                        </a>
                                    @else
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('fechas')
                                        <a href="#" class="editable" data-type="text" data-name="fecha_descargue"
                                            data-pk="{{ $diario->id }}">
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('fechas')
                                        <a href="#" class="editable" data-type="text" data-name="hora_descargue"
                                            data-pk="{{ $diario->id }}">
                                ...
                                <td class="celdas"
                                    ...
                                    <span class="badge bg-{{ $diario->color }}"
                                        style="color:{{ $diario->font }};font-weight:600;">{{ strToUpper($diario->states) }}</span>
                                </td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('placa')
                                        ...
                                        @if ($diario->enviado == 'NO')
                                            <a href="#" class="editable {{ $estadoClase }}" data-type="select"
                                                data-name="paytype" data-pk="{{ $diario->id }}"
                                                data-source='@json($fuentePago)'
                                ...
                                <td class="celdas"
                                    ...
                                    @endphp
                                    <span class="{{ $clase }}"
                                        style="color:{{ $colortexto }};font-weight:600">{{ $diario->sucursal }}</span>
                                </td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('remesa')
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('remesa')
                                        <a href="#" class="editable" data-type="text" data-name="remesa"
                                            data-pk="{{ $diario->id }}">
                                ...
                                <td class="celdas"
                                    ...
                                    @can('remesa')
                                        @php
                                            ...
                                            if (
                                                in_array(strToUpper($diario->razon), [
                                                    'LINKARGA',
                                                    'HUMADEA',
                                                    'SERVICARGA',
                                                    'KONFIE',
                                        ...
                                        @if ($diario->razon === null)
                                            <a href="#" class="editable {{ $estadoClase }}" data-type="text"
                                                data-name="razon" data-pk="{{ $diario->id }}">
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('remesa')
                                        <a href="#" class="editable" data-type="text" data-name="radicado"
                                            data-pk="{{ $diario->id }}">
                                ...
                                <td class="celdas"
                                    ...
                                    <a href="#" data-id="{{ $diario->id }}"
                                        class="btn btn-icon-square-xs py-0 my-0" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalCenter6"
                                        style="background-color:{{ $diario->carcolor }}"><svg width="16"
                                            ...
                                            <g transform="translate(0 -1028.4)">
                                                <path d="m2 4v13.531 2.469c0 1.105 0.8954 2 2 2h4 8l6-6v-12h-20z"
                                                    transform="translate(0 1028.4)" fill="#f1c40f" />
                                ...
                                <td class="celdas"
                                    ...
                                    @can('edita.cotizacion')
                                        <a href="javascript:void(0)"
                                            data-url="{{ route('solicitudes.toggleTrafico', $diario->id) }}"
                                            class="btn btn-icon-square-xs py-0 my-0 btn-toggle-trafico"
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 36 36"
                                                ...
                                                <path fill="#31373D"
                                                    d="M36 23a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V13a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4v10z">
                                                </path>
                                                <circle fill="#77B255" cx="7" cy="18" r="4"></circle>
                                                <circle fill="#FFCC4D" cx="18" cy="18" r="4"></circle>
                                                <circle fill="#DD2E44" cx="29" cy="18" r="4"></circle>
                                            </svg>
                                        </a>
                                    @else
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    <span class="btn btn-icon-square-xs py-0 my-0" style="background-color:#4CCD99"><i
                                            class="fas fa-check" style="color: white"></i></span>
                                    {{-- @can('servicio')
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ date('H:i', strtotime($diario->oridates)) }}</td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    <span class="btn btn-icon-square-xs py-0 my-0" style="background-color:#4CCD99"><i
                                            class="fas fa-check" style="color: white"></i></span>
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ date('H:i', strtotime($diario->saldates)) }}</td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    <span class="btn btn-icon-square-xs py-0 my-0" style="background-color:#4CCD99"><i
                                            class="fas fa-check" style="color: white"></i></span>
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ date('H:i', strtotime($diario->desdates)) }}</td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    @can('servicio')
                                        <a href="#" data-id="{{ $diario->id }}"
                                            ...
                                            style="background-color:{{ $diario->fincolor }}"><i
                                                class="{{ $diario->finimage }}" style="color: white"></i></a>
                                    @else
                                        <a href="#" data-id="{{ $diario->id }}"
                                            class="btn btn-icon-square-xs py-0 my-0"
                                            style="background-color:{{ $diario->fincolor }}"><i
                                                class="{{ $diario->finimage }}" style="color: white"></i></a>
                                    @endcan
                                </td>
                                ...
                                <td class="celdas"
                                    ...
                                    @can('cancelar')
                                        <a href="#" data-id="{{ $diario->id }}"
                                            ...
                                            style="background-color:{{ $diario->cancolor }}"><i
                                ...
                                @can('cierres')
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        <a href="" class="btn btn-icon-square-xs py-0 my-0 update-solicitud"
                                            data-id="{{ $diario->id }}" style="background-color: #7A64BA"><i
                                ...
                                @can('fechas')
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        <a href="#" class="editable" data-type="select" data-name="origen"
                                            data-pk="{{ $diario->id }}" data-source='@json($places)'
                                            style="font-weight:500;font-size:10px;">
                                ...
                                @can('fechas')
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        <a href="#" class="editable" data-type="select" data-name="destino"
                                            data-pk="{{ $diario->id }}" data-source='@json($places)'
                                            style="font-weight:500;font-size:10px;">
                                ...
                                @can('fechas')
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        <a href="#" class="editable" data-type="select" data-name="tipo_vehiculo"
                                            data-pk="{{ $diario->id }}" data-source='@json($types)'
                                            style="font-weight:500;font-size:10px;">
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ $diario->carroceria }}</td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ strtoupper($diario->ejecutivo) }}</td>
                                ...
                                @can('costos')
                                    <td class="celdas"
                                        ...
                                        @can('placa')
                                            @if ($diario->enviado == 'NO')
                                                <a href="#" class="editabler" data-type="text" data-name="costo"
                                ...
                                <td class="celdas"
                                    ...
                                    @if ($diario->soporte)
                                        ...
                                        @endphp
                                        <a href="{{ route('solicitud.showSoporte', $diario->id) }}" target="_blank"
                                            title="Ver soporte">
                                            @if ($esPdf)
                                ...
                                <td class="celdas"
                                    ...
                                    @can('placa')
                                        <a href="#" class="editable" data-type="select" data-name="tipo"
                                            data-pk="{{ $diario->id }}"
                                            data-source='[{"value":"ANTIGUO","text":"ANTIGUO"},{"value":"NUEVO","text":"NUEVO"},{"value":"","text":""}]'>
                                            {{ $diario->tipo }}
                                        </a>
                                    @else
                                        {{ $diario->tipo }}
                                ...
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    {{ $diario->registrado }}</td>
                                <td class="celdas"
                                    style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    <a href="{{ url('/solicitud/' . $diario->id) }}"><svg height="16"
                                            width="16" version="1.1" id="Capa_1"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 385 385"
                                            xml:space="preserve">
                                            <g id="XMLID_1027_">
                                                ...
                                                <path id="XMLID_1031_" style="fill:#FFE98F;"
                                                    d="M157.5,150c-24.813,0-45-20.186-45-45V85h30v20c0,8.271,6.729,15,15,15V55h-15h-30   H7.5v300h69.826H157.5V150z" />
                                                <path id="XMLID_1032_" style="fill:#FFDA44;"
                                                    d="M307.5,340.163V55H203.612H202.5v50c0,24.814-20.187,45-45,45v205h75.818H307.5   V340.163z" />
                                ...
                                <td class="celdas"
                                    ...
                                    @if (!empty($diario->telefono_conductor))
                                        ...
                                        <a href="https://wa.me/{{ $telefono }}?text={{ $mensaje }}"
                                            target="_blank"><svg width="14" height="14"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header flex">
                ...
                <h6 class="modal-title m-0 flex" id="exampleModalCenterTitle" style="color: #FFDB00"> Llegada a
                    origen</h6>
                    ...
                    <div class="card-body">
                        <form id="crn2" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="oriuser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="oridate" value=""
                                    autocomplete="off">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" name="saluser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="saldate" value=""
                                    autocomplete="off">
                                <label>Fecha y hora</label>
                            </div>
                            <div class="form-floating mb-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="desuser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="desdate" value=""
                                    autocomplete="off">
                                <label>Fecha y hora</label>
                            </div>
                            <div class="form-floating mb-2">
...
<div class="modal fade" id="exampleModalCenter4" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header flex">
                <h6 class="modal-title" style="color: white;margin-right:5px;">Evento: </h6>
                <h6 class="modal-title m-0 flex" id="exampleModalCenterTitle" style="color: #FFDB00"> Finalizar
                    servicio</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div><!--end modal-header-->
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="finuser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="findate" value=""
                                    autocomplete="off">
                                <label>Fecha y hora</label>
                            </div>
                            <div class="form-floating mb-2">
                                <select class="form-select" id="floatingTextarea2" name="finnote"
                            ...
                            <div class="form-floating mb-2">
                                <select class="form-select" id="floatingTextarea2" name="responsable"
                                    autocomplete="off" aria-label="Floating label select example">
                                    <option selected disabled>Seleccionar</option>
                            ...
                            <div class="form-floating mb-2">
                                <select class="form-select" id="floatingTextarea2" name="cte"
                                    autocomplete="off" aria-label="Floating label select example">
                                    <option selected disabled>Seleccionar</option>
                                    <option>1</option>
                                    <option>2</option>
                            ...
                            <div class="form-floating mb-2">
                                <select class="form-select" id="floatingTextarea2" name="ays"
                                    autocomplete="off" aria-label="Floating label select example">
                                    <option selected disabled>Seleccionar</option>
                                    <option>1</option>
                                    <option>2</option>
                            ...
                            <div class="form-floating mb-2">
                                <textarea class="form-control" id="floatingTextarea2" name="nota_cierre" autocomplete="off"
...
<div class="modal fade" id="exampleModalCenter5" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header flex">
                <h6 class="modal-title" style="color: white;margin-right:5px;">Evento: </h6>
                <h6 class="modal-title m-0 flex" id="exampleModalCenterTitle" style="color: #FF5580"> Cancelar
                    servicio</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div><!--end modal-header-->
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="canuser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="candate" value=""
                                    autocomplete="off">
                                <label>Fecha y hora</label>
                            </div>
                            <div class="form-floating mb-2">
                            ...
                            <div class="form-floating mb-2">
                                <select class="form-select" id="floatingTextarea2" name="cannote"
                                    autocomplete="off" aria-label="Floating label select example">
                                    <option selected disabled>Seleccionar</option>
...
<div class="modal fade" id="exampleModalCenter6" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header flex">
                <h6 class="modal-title" style="color: white;margin-right:5px;">Evento: </h6>
                <h6 class="modal-title m-0 flex" id="exampleModalCenterTitle" style="color: #FFFFFF"> Notas de
                    cargue</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div><!--end modal-header-->
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="caruser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="cardate" value=""
                                    autocomplete="off">
                                <label>Fecha y hora</label>
                            </div>
                            <div class="form-floating mb-2">
...
<script>
    $(document).ready(function() {
        $('.update-solicitud').on('click', function(e) {
            ...
            var oridate = new Date(date.getTime() - (3 * 60 * 60 * 1000)).toISOString().slice(0, 19)
                .replace('T', ' ');
            var saldate = new Date(date.getTime() - (2 * 60 * 60 * 1000)).toISOString().slice(0, 19)
                .replace('T', ' ');
            var desdate = new Date(date.getTime() - (1 * 60 * 60 * 1000)).toISOString().slice(0, 19)
                .replace('T', ' ');
            ...
            $.ajax({
                ...
                error: function(response) {
                    alert('Error al actualizar la solicitud: ' + response.responseJSON
    ...
    $(document).ready(function() {
        $('#exampl').DataTable({
            ...
            columnDefs: [{
                    orderable: false,
                    targets: 'no-sort'
                } // opcional: desactivar orden en columnas específicas
            ]
        });
    });
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire('Error', response.message ||
                            'No se pudo actualizar el tráfico.', 'error');
                    }
                },
                error: function() {
