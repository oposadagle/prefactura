                    ...
                    <div class="container">
                        <div class="row gx-1 justify-content-between py-4">
                            ...
                            <div class="col-lg-2 col-md-6">
                                <div class="form-floating mb-3">
                                    <input style="text-align: right" type="text" class="form-control"
                                        id="timepikcr" name="hora_descargue" readonly autocomplete="off">
            ...
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (response.status === 422 && contentType && contentType.includes(
                                'application/json')) {
                            ...
                            if (errors.errors) {
                                Object.keys(errors.errors).forEach(field => {
                                    ...
                                    errorMessages += '<li>' + messages.join('</li><li>') +
                                        '</li>';
                                });
                            }
                            ...
                            Swal.fire({
                                ...
                                html: '<div style="text-align: left;"><ul style="list-style: disc; margin-left: 20px;">' +
