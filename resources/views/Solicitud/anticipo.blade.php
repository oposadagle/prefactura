...
<style>
    ...
    #example td:nth-child(1) {
        ...
        overflow: visible;
        /* Allow content to be seen complete */
        text-overflow: clip;
        max-width: none;
        width: auto;
    }
                ...
                <div class="d-flex">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <rect x="68.002" y="3.995" style="fill:#FFFFFF;" width="375.996" height="504.001"></rect>
                            <path style="fill:#000000;" d="M440.001,8V504H72V8H440.001 M448,0H64v512H448V0z"></path>
                            <rect x="106.636" y="370.238" style="fill:#002833;" width="298.639" height="10.64"></rect>
                            <g>
                                <rect x="106.636" y="412.876" style="fill:#000000;" width="298.639" height="10.64">
                                </rect>
                                <rect x="106.636" y="434.236" style="fill:#000000;" width="298.639" height="10.64">
                                </rect>
                                <rect x="106.636" y="455.525" style="fill:#000000;" width="298.639" height="10.64">
                                </rect>
                            </g>
                            <g>
                                <path style="fill:#E21B1B;"
                                    d="M392,338.24h-272c-8.826-0.026-15.974-7.175-16-16V124.88c0.026-8.826,7.175-15.974,16-16h272 c8.826,0.026,15.973,7.175,16,16v197.361C407.974,331.066,400.826,338.214,392,338.24z">
                                </path>
                                <rect x="103.996" y="44.88" style="fill:#E21B1B;" width="53.358" height="31.999"></rect>
                            </g>
                            <rect x="189.363" y="44.88" style="fill:#000000;" width="218.642" height="31.999"></rect>
                            <rect x="163.361" y="269.838" style="fill:#FFFFFF;" width="21.36" height="24.88"></rect>
                            <rect x="204.316" y="240.479" style="fill:#999999;" width="21.36" height="54.245"></rect>
                            <rect x="245.361" y="211.12" style="fill:#FFFFFF;" width="21.36" height="83.6"></rect>
                            <rect x="286.316" y="181.762" style="fill:#999999;" width="21.36" height="112.962"></rect>
                            <rect x="327.36" y="152.403" style="fill:#FFFFFF;" width="21.36" height="142.321"></rect>
                        </g>
                    </svg>
                    ...
                    <table id="example" class="table table-striped mb-0">
                        <thead class="table-dark" style="font-size: 11px;">
                            <tr>
                                ...
                                <th class="celdas" style="color: #CAF4FF;border: 1px solid #0c213a;">CONDICION DE PAGO
                                </th>
                                ...
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">PAGAR ANTICIPO A
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">CEDULA ANTICIPO
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">PAGAR SALDO A
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">CEDULA SALDO</th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">PAGAR CONTADO A
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">CEDULA CONTADO
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">FACT ELECTRONICA
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">TIPO VEHICULO
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">EDITAR</th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">PAGO COMPLETO
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">TIPO LEGALIZACION
                                </th>
                                <th class="celdas" style="color: #FFAF61;border: 1px solid #0c213a;">CENTRO DE COSTO
                                </th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">COSTO</th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">VALOR ANTICIPO
                                </th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">EXTRA</th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">VALOR A PAGAR
                                </th>
                                ...
                                @endcan
                                <th class="celdas" style="color: #F3F8FF;border: 1px solid #0c213a;">NOTAS DEDUCCIONES
                                </th>
                            </tr>
                        </thead>
                            ...
                            @foreach ($diarias as $diario)
                                <tr style="text-align: center">
                                    ...
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        @can('validar')
                                            <a href="#" class="editable" data-type="text" data-name="factura"
                                                data-pk="{{ $diario->id }}">
                                                {{ $diario->factura }}
                                            </a>
                                        @else
                                    ...
                                    <td class="celdas"
                                        ...
                                        <a href="#" data-id="{{ $diario->id }}"
                                            ...
                                            style="background-color:{{ $colorB }}"><svg width="16"
                                    ...
                                    <td class="celdas"
                                        ...
                                        <a href="#" data-id="{{ $diario->id }}"
                                            class="btn btn-icon-square-xs py-0 my-0" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter13"><svg version="1.1" id="Layer_1"
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
                                                xml:space="preserve" height="16" width="16">
                                                <path style="fill:#DCE5FA;"
                                                ...
                                                <rect x="313.801" y="212.786"
                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 477.6891 678.7643)"
                                    ...
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ $diario->tipo_legalizacion }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ $diario->centro_costo }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->costo, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->anticipo, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->costo_tiposerv, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->valor_a_pagar, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->retefuente, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    ...
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ number_format($diario->valor_saldo, 0, ',', '.') }}</td>
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    ...
                                    <td class="celdas"
                                        ...
                                        <span class="{{ $estadoClase }}"
                                            style="font-weight:600;">{{ $diario->estado_anticipo }}</span>
                                    </td>

                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC; padding-top:10px; padding-bottom:10px;">
                                        <span class="badge {{ $diario->pagado ? 'bg-info' : 'bg-orange' }}"
                                    ...
                                    @can('vehiculo.index')
                                        <td class="celdas"
                                            ...
                                            @endphp
                                            @if ($diario->enviado == 'NO')
                                                <a href="#" class="editablef {{ $estadoClase }}" data-type="text"
                                                    data-name="enviado" data-pk="{{ $diario->id }}"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header flex">
                ...
                <h6 class="modal-title m-0 flex" id="exampleModalCenterTitle" style="color: #FFFFFF">Notas de cargue
                </h6>
                    ...
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="floatingInput" name="antuser"
                                    value="{{ $userName }}" readonly>
                                <label>Usuario</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control" name="antdate" value=""
                                    autocomplete="off">
                    ...
                    <div class="card-body">
                        <form id="crn3" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-2">
                                <div class="col-md">
                                    <div class="form-floating mb-2">
                                        <input type="date" class="form-control" name="recibido_cumplido"
                                            autocomplete="off">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="crn4" action="" method="POST" enctype="multipart/form-data">
                            ...
                            {{ method_field('PUT') }}
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" name="egreso_anticipo"
                                    autocomplete="off">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const festivos = @json($festivos).map(f => new Date(f +
            'T00:00:00')); // Convertir a Date y normalizar a medianoche
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert('Error al actualizar: ' + response
                        .message); // Mostrar el mensaje de error del servidor
                }
            },
...
<script>
    $(document).ready(function() {
        $('.btn-detalle-novedad').click(function() {
            ...
            $('#tbodyDetalleNovedad').html('<tr><td colspan="8" class="text-center">Cargando...</td></tr>');
            ...
            $.get('{{ route("solicitud.detalleNovedades", ["manifiesto" => "__MAN__"]) }}'.replace('__MAN__', manifiesto), function(data) {
                ...
                $('#tbodyDetalleNovedad').html('<tr><td colspan="8" class="text-center text-danger">Error al cargar</td></tr>');
            });
        });
    });
</script>
