            ...
            <div class="card-header d-flex justify-content-between align-items-center m-2">
                ...
                <form method="GET" action="{{ route('solicitud.historico') }}" class="d-flex">
                    ...
                    <div class="input-group me-2" style="width:180px">
                        ...
                        <select class="form-select" name="cuenta_de_cobro" style="font-size: 11px" onchange="this.form.submit()">
                            <option selected disabled>CUENTA DE COBRO</option>
                            <option value="SI" {{ request('cuenta_de_cobro') == 'SI' ? 'selected' : '' }}>SI</option>
                            <option value="NO" {{ request('cuenta_de_cobro') == 'NO' ? 'selected' : '' }}>NO</option>
                        </select>
                    </div>
                    <!-- Select de Año -->
