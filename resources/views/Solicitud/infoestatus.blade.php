            ...
            <div class="card-header d-flex justify-content-between align-items-center m-2">
                <div class="d-flex">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 392.58 392.58" xml:space="preserve"
                        width="24" height="24" fill="#FFF" stroke="#FFF">
                        <g id="SVGRepo_bgCarrier" stroke-width="0" />
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                        <g id="SVGRepo_iconCarrier">
                            <path style="fill:#FF2029FFFFF;"
                                d="M337.227,43.304c0-6.012-4.848-10.925-10.925-10.925H66.359c-6.012,0-10.925,4.848-10.925,10.925 v217.341h281.729L337.227,43.304L337.227,43.304z" />
                            <rect x="88.08" y="65.025" style="fill:#6495BB;" width="216.372" height="162.909" />
                            <g>
                                <path style="fill:#000;"
                                    d="M125.704,203.369c6.012,0,10.925-4.848,10.925-10.925v-60.38c0-6.012-4.848-10.925-10.925-10.925 s-10.925,4.848-10.925,10.925v60.38C114.843,198.391,119.692,203.369,125.704,203.369z" />
                                <path style="fill:#000;"
                                    d="M172.767,203.369c6.012,0,10.925-4.848,10.925-10.925v-39.499c0-6.012-4.848-10.925-10.925-10.925 c-6.077,0-10.925,4.848-10.925,10.925v39.499C161.906,198.391,166.755,203.369,172.767,203.369z" />
                                <path style="fill:#000;"
                                    d="M219.829,203.369c6.012,0,10.925-4.848,10.925-10.925v-70.788c0-6.012-4.848-10.925-10.925-10.925 c-6.012,0-10.925,4.848-10.925,10.925v70.788C208.969,198.391,213.817,203.369,219.829,203.369z" />
                                <path style="fill:#000;"
                                    d="M266.892,203.369c6.012,0,10.925-4.848,10.925-10.925V100.71c0-6.012-4.849-10.925-10.925-10.925 c-6.012,0-10.925,4.848-10.925,10.925v91.669C256.031,198.391,260.88,203.369,266.892,203.369z" />
                            </g>
                            <path style="fill:#FF2029;"
                                d="M51.619,282.561l-3.556,10.731h33.099c6.012,0,10.925,4.848,10.925,10.925 c0,6.012-4.848,10.925-10.925,10.925h-40.21l-4.073,12.541h16.549c6.012,0,10.925,4.848,10.925,10.925 c0,6.012-4.848,10.925-10.925,10.925H29.704l-3.556,10.731h340.493l-25.471-77.64H51.619V282.561z" />
                            <g>
                                <path style="fill:#000;"
                                    d="M391.918,367.7l-32.711-99.556c-0.065-0.129-0.129-0.323-0.259-0.453V43.304 c0-18.036-14.675-32.711-32.711-32.711H66.359c-18.036,0-32.711,14.675-32.711,32.711v224.323 c-0.065,0.129-0.259,0.323-0.259,0.517L0.613,367.7c-2.392,6.335,2.457,14.287,10.343,14.287h370.618 C388.233,381.987,394.698,375.199,391.918,367.7z M26.148,360.201l3.556-10.731h23.661c6.012,0,10.925-4.848,10.925-10.925 s-4.848-10.925-10.925-10.925H36.815l4.073-12.541h40.21c6.012,0,10.925-4.848,10.925-10.925c0-6.012-4.848-10.925-10.925-10.925 h-32.97l3.556-10.731h289.358l25.471,77.64H26.148V360.201z M55.433,43.304c0-6.012,4.848-10.925,10.925-10.925h259.943 c6.012,0,10.925,4.848,10.925,10.925v217.341H55.433V43.304z" />
                                <path style="fill:#000;"
                                    d="M220.411,326.068h-48.226c-6.012,0-10.925,4.848-10.925,10.925c0,6.012,4.848,10.925,10.925,10.925 h48.226c6.012,0,10.925-4.848,10.925-10.925S226.423,326.068,220.411,326.068z" />
                            </g>
                        </g>
                    </svg>
                ...
                <form action="{{ route('solicitud.estatus') }}" method="GET" class="d-flex align-items-center">
                    ...
                    <div class="me-2">
                        <select class="form-select" name="month" id="month_select"
                            style="min-width: 130px; font-size: 14px;">
                            <!-- Options populated by JS -->
                        </select>
                    </div>

                    <button type="submit" class="btn btn-primary d-flex align-items-center"
                        style="margin-left:5px;font-size: 12px;font-family: Titillium Web;font-weight: 700;">
                    ...
                    <table id="exampleie" class="table table-striped">
                        <thead class="table-dark" style="font-size: 11px;position: sticky;top: 0;z-index: 1000;">
                            <tr>
                                ...
                                <th class="      " style="color: #FFAF61;border: 1px solid #0c213a;">VALOR DECLARADO
                                </th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">TIPO VEHICULO
                                </th>
                                <th class="celdas" style="color: #FFDB00;border: 1px solid #0c213a;">TIPO CARROCERIA
                                </th>
                                ...
                                <th class="celdas" style="color: #F7E6AD;border: 1px solid #0c213a;">TIPO SERVICIO
                                </th>
                                <th class="celdas" style="color: #F7E6AD;border: 1px solid #0c213a;">NOTA SERVICIO
                                </th>
                                @can('egresos')
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO COSTO
                                        FLETE</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO TIPO
                                        SERVICIO</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO CYD 1
                                    </th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO CYD 2
                                    </th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO STANDBY
                                    </th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO
                                        MONTACARGA</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO ESCOLTA
                                    </th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO CANDADO
                                        SATELITAL</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO
                                        MONITOREO</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO ESTUDIO
                                        SEGURIDAD</th>
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO
                                        SOBRECOSTO TRANSPORTE</th>
                                @endcan
                                @can('egresos.lectura')
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO COSTO
                                        FLETE</th>
                                    ...
                                    <th class="" style="color: #FFACAC;border: 1px solid #0c213a;">DOCUMENTO
                                        SOBRECOSTO TRANSPORTE</th>
                                @endcan
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO DE FLETE
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">DESC COND Y/O
                                    PROPIETARIO</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">% COSTO SEGURO
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO SEGURO</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO TIPO
                                    SERVICIO</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PCYD1</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO CARGUE Y
                                    DESCARGUE1</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PCYD2</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO CARGUE Y
                                    DESCARGUE2</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PSBY</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO STAND BY
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PCD</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO
                                    DESPLAZAMIENTO</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PMTC</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO MONTACARGAS
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PESC</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO ESCOLTA
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PCAS</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO CANDADO
                                    SATELITAL</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PMON</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO MONITOREO
                                </th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">PESG</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO ESTUDIO
                                    SEGURIDAD</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">COSTO AMPLIACION
                                    POLIZA</th>
                                <th class="      " style="color: #F7E6AD;border: 1px solid #0c213a;">SOBRECOSTOS
                                    TRANSPORTADORA</th>
                                ...
                                <th class="      " style="color: #C3FF93;border: 1px solid #0c213a;">VALOR COBRAR_EN
                                    SEGURO</th>
                                <th class="      " style="color: #C3FF93;border: 1px solid #0c213a;">VALOR COBRAR
                                    SOBRECOSTOS</th>
                                <th class="      " style="color: #C3FF93;border: 1px solid #0c213a;">VALOR SERVICIOS
                                    COMP.</th>
                                <th class="      " style="color: #C3FF93;border: 1px solid #0c213a;">VALOR TOTAL_A
                                    COBRAR</th>
                                ...
                                <th class="celdas" style="color: #B6FFFA;border: 1px solid #0c213a;"><i
                                        class="ti ti-calendar"></i>CIERRE</th>
                                <th class="celdas" style="color: #B6FFFA;border: 1px solid #0c213a;">CONGELADO</th>
                                <th class="celdas" style="color: #B6FFFA;border: 1px solid #0c213a;"><i
                                        class="ti ti-calendar"></i>CONGELADO</th>
                                @can('egresos')
                                    <th class="celdas" style="color: #FFACAC;border: 1px solid #0c213a;">EGRESO ANTICIPO
                                    </th>
                                    <th class="celdas" style="color: #FFACAC;border: 1px solid #0c213a;">EGRESO SALDO</th>
                                    <th class="celdas" style="color: #FFACAC;border: 1px solid #0c213a;">FECHA PAGO SALDO
                                    </th>
                                @endcan
                                @can('egresos.lectura')
                                    <th class="celdas" style="color: #FFACAC;border: 1px solid #0c213a;">EGRESO ANTICIPO
                        ...
                        <tbody style="font-size: 12px;font-family: Titillium Web;">
                            @foreach ($diarias as $diario)
                                <tr class="celdasa" style="text-align: center">
                                    ...
                                    <td class="celdas"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        {{ strToUpper($diario->destino_final) }}</td>
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex truncated" data-type="text"
                                                    data-name="documento_cliente" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex truncated" data-type="text"
                                                    data-name="destinatario" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text" data-name="piezas"
                                                    data-pk="{{ $diario->ide }}">
                                                    {{ $diario->piezas }}
                                                </a>
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text" data-name="peso"
                                                    data-pk="{{ $diario->ide }}">
                                                    {{ $diario->peso }}
                                                </a>
                                            </td>
                                            <td class="celdas"
                                                ...
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="valor_declarado" data-pk="{{ $diario->ide }}">
                                        ...
                                        @else
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->valor_declarado, 0, ',', '.') }}</td>
                                        @endcan
                                    @else
                                        <td class="celdas"
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    ...
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="select"
                                                    data-name="proveedores" data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->proveedores }}
                                                </a>
                                            </td>
                                        @else
                                    ...
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="causal_mas" data-pk="{{ $diario->ide }}">
                                                    {{ $diario->causal_mas }}
                                                </a>
                                            </td>
                                        @else
                                    ...
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                ...
                                                <a href="#" class="editablex" data-type="select"
                                                    data-name="tipo_servicio" data-pk="{{ $diario->ide }}"
                                                    data-source='@json($servicios)'>
                                    ...
                                    <td class="celdas"
                                        ...
                                        @if ($diario->facturar == 'NO')
                                            @can('nuevos.costos')
                                                <a href="#" class="editablex truncated" data-type="text"
                                                    data-name="nota_servicio" data-pk="{{ $diario->ide }}">
                                    ...
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                ...
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_flete" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="desconductor" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="monto_costo" data-pk="{{ $diario->ide }}">
                                                    {{ $diario->monto_costo }}
                                                </a>
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="costo_seguro" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_tiposerv"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_tiposerv, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pcyd"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pcyd }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_cardes"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_cardes, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="paux"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->paux }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_auxiliar "
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_auxiliar, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="psby"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->psby }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_standby"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_standby, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pcd }}</td>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pmtc"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pmtc }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_montacarga"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_montacarga, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pesc"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pesc }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_escolta"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_escolta, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pcas"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pcas }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                ...
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_cs"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_cs, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pmon"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pmon }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_monitoreo"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_monitoreo, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                                <a href="#" class="editablex" data-type="select" data-name="pesg"
                                                    data-pk="{{ $diario->ide }}"
                                                    data-source='@json($autos)'>
                                                    {{ $diario->pesg }}
                                                </a>
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_estudio"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_estudio, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="costo_ampoliza"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->costo_ampoliza, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="sobrecosto_op"
                                                    data-pk="{{ $diario->ide }}">{{ number_format($diario->sobrecosto_op, 0, ',', '.') }}
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text" data-name="seguros"
                                                    data-pk="{{ $diario->ide }}">
                                        ...
                                        @else
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_flete, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->desconductor, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->monto_costo }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_seguro, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_tiposerv, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pcyd }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_cardes, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->paux }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_auxiliar, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->psby }}</td>
                                            <td class="celdas"
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_montacarga, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pesc }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_escolta, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pcas }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_cs, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pmon }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_monitoreo, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->pesg }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_estudio, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->costo_ampoliza, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->sobrecosto_op, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->seguros, 0, ',', '.') }}</td>
                                        @endcan
                                    @else
                                        <td class="celdas"
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                    ...
                                    <td class="celdas text-center"
                                        style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        @if ($diario->es_principal && $diario->total_novedades > 0)
                                    ...
                                    @if ($diario->facturar == 'NO')
                                        @can('nuevos.costos')
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="valor_cliente" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="monto_seguro" data-pk="{{ $diario->ide }}">
                                                    {{ $diario->monto_seguro }}
                                                </a>
                                            </td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editablex" data-type="text"
                                                    data-name="seguro_03" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="valor_sobrecosto" data-pk="{{ $diario->ide }}">
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                <a href="#" class="editabler" data-type="text"
                                                    data-name="valor_servicios" data-pk="{{ $diario->ide }}">
                                        ...
                                        @else
                                            ...
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ $diario->monto_seguro }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                                {{ number_format($diario->seguro_03, 0, ',', '.') }}</td>
                                            <td class="celdas"
                                                style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        ...
                                        <td class="celdas"
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                            {{ number_format($diario->utilidad, 0, ',', '.') }}</td>
                                        @php
                                            $estadoClase = '';
                                        ...
                                        <td class="celdas"
                                            ...
                                            <span class="{{ $estadoClase }}"
                                                style="font-weight: 600">{{ number_format($diario->rentabilidad, 1) }}
                                                %</span>
                                        </td>
                                        <td class="celdas"
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;">
                                        ...
                                        <td class="celdas"
                                            ...
                                            @if ($diario->facturar == 'NO')
                                                ...
                                                <a href="#" class="editablef {{ $estadoClase }}"
                                                    data-type="text" data-name="facturar"
                                                    data-pk="{{ $diario->ide }}">
                                                    {{ $diario->facturar }}
                                                </a>
                                            @else
                                    ...
                                    @can('egresos.lectura')
                                        <td
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                            {{ $diario->egreso_anticipo }}</td>
                                        <td
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                            {{ $diario->egreso_saldo }}</td>
                                        <td
                                            style="border: 1px solid #9FAACC;padding-top:10px;padding-bottom:10px;font-size: 11px;">
                                            {{ $diario->fecha_saldo }}</td>
                                    @endcan
                                </tr>
                            @endforeach
                        </tbody>
...
<script>
    function abrirModalDetalleNovedad() {
