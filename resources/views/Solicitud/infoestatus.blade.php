    ...
    <div class="col-sm-12"> 
        ...
        <div class="card">
                    ...
                    <div class="col-lg-3">
                        ...
                        @csrf
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary" style="font-size: 12px;font-family: Titillium Web;font-weight: 700;" type="submit" id="inputGroupFileAddon04">CARGAR</button>
                            </div>
                        </form>
                    </div>
                @endcan
            ...
            <form action="{{ route('solicitud.estatus') }}" method="GET" class="d-flex align-items-center">
                ...
                <button type="submit" class="btn btn-primary d-flex align-items-center" style="margin-left:5px;font-size: 12px;font-family: Titillium Web;font-weight: 700;">
